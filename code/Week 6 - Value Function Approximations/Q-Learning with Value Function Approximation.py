...
class Estimator:
    ...
    def featurize_state(self, state):
        ...
        try:
            ...
            scaled = scaler.transform([state[0]])
    ...
    def predict(self, s, a=None):
        ...
        if a is not None:
            ...
            predictions = np.array(
                [self.models[i].predict([self.featurize_state(s)]) for i in range(env.action_space.n)])
...
plotting.plot_cost_to_go_mountain_car(env, estimator, 0)
plotting.plot_cost_to_go_mountain_car(env, estimator, 1)
plotting.plot_cost_to_go_mountain_car(env, estimator, 2)
